...
export const education = defineType({
  ...
  fields: [
    ...
    defineField({ name: "endYear", title: "End Year", type: "string", description: 'e.g. "2026" or "Present"' }),
    defineField({ name: "gpa", title: "GPA", type: "string", description: 'e.g. "3.68"' }),
    defineField({ name: "gpaScale", title: "GPA Scale", type: "string", description: 'e.g. "4.0"' }),
    defineField({ name: "status", title: "Status", type: "string", options: { list: [{ title: "Ongoing", value: "ongoing" }, { title: "Completed", value: "completed" }] } }),
